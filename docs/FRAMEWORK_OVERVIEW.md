...
| Version | Highlights |
|---------|------------|
| **7.0.6** (2026-01-29) | Launcher now rebuilds the frontend via `scripts/build_frontend.py` before starting services so the GUI matches the backend version every time. |
