...
- **MULTI-AI RELAY AGENT** `FRAMEWORK_OVERVIEW.md#multi-ai-relay-agent` - relay handoff workflow, context snapshots, and provider order
...
- **MODULE UPGRADE CHECKLIST** `FRAMEWORK_OVERVIEW.md#module-upgrade-checklist-template` - upgrade steps and validation reminders
- **AGENTVOICE MODULE PATTERNS** `FRAMEWORK_OVERVIEW.md#agentvoice-patterns-module-example` - sample AgentVoice usage for modules
...
- **MODULE MANAGEMENT HINTS** `FRAMEWORK_OVERVIEW.md#module-management-hints` - critical module toggles now surface warning chips and tooltips.
